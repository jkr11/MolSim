...
/**
 * tests warping in 3D for x, y and z periodic
 */
TEST(PeriodicBoundary3D, warpingXYZ) {
  const LinkedCellsContainer container(
      {.domain = {3, 3, 3},
       .cutoff_radius = 1,
       .boundary_config = {
  ...
  EXPECT_IVEC3_EQ(new_coordinates, {0, 0, 2});
  DVEC3_NEAR(offset, expected_offset801, "Offset wrong", 1e-5);
  ...
  EXPECT_IVEC3_EQ(new_coordinates, {0, 0, 0});
  DVEC3_NEAR(offset, expected_offset803, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "da";
  EXPECT_IVEC3_EQ(new_coordinates, {0, 2, 2});
  DVEC3_NEAR(offset, expected_offset811, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "de";
  EXPECT_IVEC3_EQ(new_coordinates, {0, 2, 0});
  DVEC3_NEAR(offset, expected_offset813, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "ca";
  EXPECT_IVEC3_EQ(new_coordinates, {0, 1, 2});
  DVEC3_NEAR(offset, expected_offset821, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "ce";
  EXPECT_IVEC3_EQ(new_coordinates, {0, 1, 0});
  DVEC3_NEAR(offset, expected_offset823, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "bb";
  EXPECT_IVEC3_EQ(new_coordinates, {0, 0, 2});
  DVEC3_NEAR(offset, expected_offset831, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "be";
  EXPECT_IVEC3_EQ(new_coordinates, {0, 0, 0});
  DVEC3_NEAR(offset, expected_offset833, "Offset wrong", 1e-5);
  ...
  EXPECT_IVEC3_EQ(new_coordinates, {0, 2, 2});
  DVEC3_NEAR(offset, expected_offset841, "Offset wrong", 1e-5);
  ...
  EXPECT_IVEC3_EQ(new_coordinates, {0, 2, 0});
  DVEC3_NEAR(offset, expected_offset843, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "db";
  EXPECT_IVEC3_EQ(new_coordinates, {0, 0, 2});
  DVEC3_NEAR(offset, expected_offset911, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "dc";
  EXPECT_IVEC3_EQ(new_coordinates, {1, 0, 2});
  DVEC3_NEAR(offset, expected_offset912, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "dd";
  EXPECT_IVEC3_EQ(new_coordinates, {2, 0, 2});
  DVEC3_NEAR(offset, expected_offset913, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "cb";
  EXPECT_IVEC3_EQ(new_coordinates, {0, 0, 1});
  DVEC3_NEAR(offset, expected_offset921, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "cc";
  EXPECT_IVEC3_EQ(new_coordinates, {1, 0, 1});
  DVEC3_NEAR(offset, expected_offset922, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "cd";
  EXPECT_IVEC3_EQ(new_coordinates, {2, 0, 1});
  DVEC3_NEAR(offset, expected_offset923, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "bb";
  EXPECT_IVEC3_EQ(new_coordinates, {0, 0, 0});
  DVEC3_NEAR(offset, expected_offset931, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "bc";
  EXPECT_IVEC3_EQ(new_coordinates, {1, 0, 0});
  DVEC3_NEAR(offset, expected_offset932, "Offset wrong", 1e-5);
  ...
  EXPECT_EQ(is_adjacent, true) << "bd";
  EXPECT_IVEC3_EQ(new_coordinates, {2, 0, 0});
  DVEC3_NEAR(offset, expected_offset933, "Offset wrong", 1e-5);
