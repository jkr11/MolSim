...
Particle::Particle(int type_arg) {
  type = type_arg;
  SpdWrapper::get()->debug("Particle generated!");
  f = {0., 0., 0.};
  old_f = {0., 0., 0.};
}
...
Particle::~Particle() { SpdWrapper::get()->debug("Particle generated"); }
